...
const Root = (0, import_index_88dff8a6.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_88dff8a6.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_88dff8a6.v)(components[0] || import_index_88dff8a6.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => {
      return `${components[2] ? `${(0, import_index_88dff8a6.v)(components[1] || import_index_88dff8a6.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
        default: () => {
          return `${(0, import_index_88dff8a6.v)(components[2] || import_index_88dff8a6.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`;
        }
      })}` : `${(0, import_index_88dff8a6.v)(components[1] || import_index_88dff8a6.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`;
    }
  })}` : `${(0, import_index_88dff8a6.v)(components[0] || import_index_88dff8a6.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
...
const template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en">\n\n  <head>\n    <meta charset="utf-8" />\n    <link rel="icon" href="' + assets2 + `/orchid.ico" />
    <!-- <meta name="viewport" content="width=device-width, initial-scale=1" /> -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans|PT+Serif" rel="stylesheet">
    <meta name="keywords" content="Hunte's Gardens, Barbados, Caribbean, vacation, attractions, nature, eco, exotic plants, nursery">
    <meta name="description" content="Hunte's Gardens and Nursery. One of Barbados' must-see attractions - lush and unusual garden, located between Welchman Hall Gully and Flower Forest.">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="turbolinks-visit-control" content="reload">

    ` + head + '\n  </head>\n\n	<body class="site flexbox between">\n		' + body + "\n	</body>\n</html>\n\n<style>\n</style>\n";
let read = null;
